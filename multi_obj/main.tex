...
\begin{frame}{Recommendation Generation \& NSGA-II}
    \begin{itemize}
        ...
        \item \textbf{Why NSGA-II?} It is explicitly designed for multi-objective optimization, overcoming the limitations of standard single-objective GAs.
        \item \textbf{Core Mechanisms \& Assumptions:}
        \begin{itemize}
            \item \textit{Non-dominated Sorting:} Solutions are ranked into fronts assuming strict Pareto dominance.
            \item \textit{Crowding Distance:} Maintains population diversity by favoring solutions in less crowded regions.
        \end{itemize}
    \end{itemize}
\end{frame}
